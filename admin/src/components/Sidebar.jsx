...
function Sidebar() {
  ...
  return (
    <div className="drawer-side is-drawer-close:overflow-visible">
      ...
      {/* parent div containing the three divs */}
      <div className="flex min-h-full flex-col items-start bg-base-200 is-drawer-close:w-14 is-drawer-open:w-64">
        {/* this is the div for shopping icon and admin */}
        ...
        {/* this div is for sidebar items or pages */}
        ...
        {/* this div is for user avatar, username and email     */}
        <div className="p-4 w-full flex items-center gap-3">
